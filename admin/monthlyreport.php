...
if(isset($_POST['month'])){
  ...
  $ryear=substr($_POST['month'],0,4);
  $rmonth=substr($_POST['month'],5,6);
}
$year=date('Y', time());
...
$ryear=substr($_SESSION['month'],0,4);
$rmonth=substr($_SESSION['month'],5,6);
}
?>
<!DOCTYPE html>
<html>
	...
	<body class="loggedin">
      ...
      if ($_GET['type']=="table") {
      $sql ="SELECT * FROM report WHERE month = $rmonth AND year = $ryear GROUP BY day order by day";
