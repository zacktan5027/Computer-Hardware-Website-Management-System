      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        echo "</thread>";
          while ($row = mysqli_fetch_assoc($result)) {
              echo "<tr>";
              echo "<td id='".$row['username']."' style='width:100px;padding: 12px 20px'>" . $row['username'] . "</td>";
              echo "<td style='width:100px;padding: 12px 20px'>" . $row['nickname'] . "</td>";
              echo "<td style='width:100px;padding: 12px 20px'>" . $row['password'] . "</td>";
              echo "<td style='width:100px;padding: 12px 20px'>" . $row['email'] . "</td>";
              echo "<td style='width:100px;padding: 12px 20px'><a style='width:100px;padding: 10px 20px' href='editstaffindex.php?id=" . $row['id'] . "'>Edit</a></td>";
              ...
              echo "<td style='width:100px;padding: 12px 20px'><a style='width:100px;padding: 10px 20px' onclick='return validate();'  href='deletestaff.php?id=" . $row['id'] . "')>Delete</a></td>";
              echo "</tr>";
