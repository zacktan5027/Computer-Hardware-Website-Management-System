...
background-color: #555;
	...
	<body class="loggedin">
      ...
      <a style="float:left"href="home.php?filter=highs">high sold <i class="fas fa-caret-up"></i></a>
      <a style="float:left" href="home.php?filter=lows">low sold <i class="fas fa-caret-down"></i></a>
   ...
   <a style="float:right" href="report.php"><i class="fas fa-newspaper"></i> Report</a>
      ...
      if (isset($_GET['filter'])) {
          if ($_GET['filter']=="high") {
              ...
              $sql = "SELECT * FROM product ORDER BY sold ASC";
          }
      } else {
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<td style='width:100px;padding: 12px 20px'><a style='width:100px;padding: 10px 20px' href='feedback.php?type=home&id=".$row['id']."'>Feedback</a></td>";
              echo "<td style='width:100px;padding: 12px 20px'><a style='width:100px;padding: 10px 20px' href='editproduct.php?type=home&id=" . $row['id'] . "'>Edit</a></td>";
    ...
    $(document).ready(function() {
    	...
    	$('.more').each(function() {
    		...
    		if(content.length > showChar) {
    			...
    			var html = c + '<span class="more ellipses">' + ellipsestext+ '</span><span class="more content" ><span style="display:none">' + h + ' </span> <a style="padding:5px 5px" href="" class="morelink">' + moretext + '</a></span>';
