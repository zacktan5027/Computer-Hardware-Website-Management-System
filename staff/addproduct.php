...
<html>
   ...
   <a style="float:right" href="report.php"><i class="fas fa-newspaper"></i> Report</a>
      ...
      <form action="addproductProcess.php" method="post" autocomplete="off" enctype="multipart/form-data">
                <label>Title:</label>
                <input style="display:block" name="name" required="" type="text" placeholder="Product name" value="<?php echo $name?>">
                <label>Description:</label>
                <textarea  name="description" rows=10 style="width:100%" placeholder="Description of the product"><?php echo $description ?></textarea>
